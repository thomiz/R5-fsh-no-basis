...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:MedicationStatement/f:identifier/f:type</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:MedicationStatement/f:reason</sch:title>
    <sch:rule context="f:MedicationStatement/f:reason">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:MedicationStatement/f:reason/f:concept</sch:title>
    <sch:rule context="f:MedicationStatement/f:reason/f:concept">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:text) &lt;= 1">text: maximum cardinality of 'text' is 1</sch:assert>
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:text) &lt;= 1">text: maximum cardinality of 'text' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:MedicationStatement/f:reason/f:concept/f:coding</sch:title>
    <sch:rule context="f:MedicationStatement/f:reason/f:concept/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
