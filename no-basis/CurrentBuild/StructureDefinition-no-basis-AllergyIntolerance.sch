...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:AllergyIntolerance/f:verificationStatus</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:AllergyIntolerance/f:verificationStatus/f:coding</sch:title>
    <sch:rule context="f:AllergyIntolerance/f:verificationStatus/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:AllergyIntolerance/f:reaction/f:manifestation/f:concept</sch:title>
    <sch:rule context="f:AllergyIntolerance/f:reaction/f:manifestation/f:concept">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:AllergyIntolerance/f:reaction/f:manifestation/f:concept/f:coding</sch:title>
    <sch:rule context="f:AllergyIntolerance/f:reaction/f:manifestation/f:concept/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:system) &gt;= 1">system: minimum cardinality of 'system' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
      <sch:assert test="count(f:version) &lt;= 1">version: maximum cardinality of 'version' is 1</sch:assert>
